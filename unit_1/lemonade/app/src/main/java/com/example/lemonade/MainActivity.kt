...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                text = resources.getString(R.string.lemon_select)
                image = R.drawable.lemon_tree
            }
            SQUEEZE -> {
                text = resources.getString(R.string.lemon_squeeze)
                image = R.drawable.lemon_squeeze
            }
            DRINK -> {
                text = resources.getString(R.string.lemon_drink)
                image = R.drawable.lemon_drink
            }
            else -> {
                text = resources.getString(R.string.lemon_empty_glass)
